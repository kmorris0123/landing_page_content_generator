...
def main():
    ...
    for page_title, page_data in page_data_dict.items():
        ...
        # Add csv_notes to the content generation function call
        content = create_page_content(page_title, page_data, outline, company_name, page_data["keyword"], page_data["city"], page_data["state"], notes, company_website, page_data["csv_notes"])
